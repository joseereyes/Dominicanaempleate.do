            ...
            <div className="container search-inputs ">
                <div className="d-flex flex-wrap justify-content-around">
                    <div className="input-container ">
                        ...
                        <input onChange={(e) => (setFilterObjec({ type: "Name", value: e.target.value }) )} type="text" placeholder="Escribe el empleo que buscas" className="input-search input-search-1" autoFocus />
                    </div>
                    <div className="input-container ">
                        <img src={locationIcon} alt="" />
                        <input type="text" placeholder="Ubicacion del empleo" className="input-search input-search-1" />
                    </div>
